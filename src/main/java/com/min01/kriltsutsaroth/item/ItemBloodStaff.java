...
public class ItemBloodStaff extends ElementsKriltsutsarothMod.ModElement {
	@GameRegistry.ObjectHolder("kriltsutsaroth:blood_staff")
	public static final Item block = null;
	public static final int ENTITYID = 29;
	public ItemBloodStaff(ElementsKriltsutsarothMod instance) {
		super(instance, 12);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityArrowCustom.class)
				.id(new ResourceLocation("kriltsutsaroth", "entitybulletblood_staff"), ENTITYID).name("entitybulletblood_staff").tracker(64, 1, true)
				.build());
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("kriltsutsaroth:blood_staff", "inventory"));
	}
	...
	public static class RangedItem extends Item {
		public RangedItem() {
			...
			setMaxDamage(100);
			setFull3D();
			setUnlocalizedName("blood_staff");
			setRegistryName("blood_staff");
			maxStackSize = 1;
	...
	public static class EntityArrowCustom extends EntityTippedArrow {
		...
		public void onUpdate() {
			...
			for (var9 = 0; var9 < 4; var9++)
		        this.world.spawnParticle(EnumParticleTypes.CRIT, this.posX + this.motionX * var9 / 4.0D, this.posY + this.motionY * var9 / 4.0D, this.posZ + this.motionZ * var9 / 4.0D, -this.motionX, -this.motionY + 0.2D, -this.motionZ); 
			if (this.inGround) {
