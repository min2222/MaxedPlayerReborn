...
import com.min01.kriltsutsaroth.procedure.ProcedureMysticFireStaffWhileBulletFlyingTick;
import com.min01.kriltsutsaroth.procedure.ProcedureMysticFireStaffBulletHitsLivingEntity;
	...
	public static class EntityArrowCustom extends EntityTippedArrow {
		...
		protected void arrowHit(EntityLivingBase entity) {
			...
			World world = this.world;
			{
				...
				ProcedureMysticFireStaffBulletHitsLivingEntity.executeProcedure($_dependencies);
			}
		}
		...
		public void onUpdate() {
			...
			this.setFire(1000);
			{
				...
				ProcedureMysticFireStaffWhileBulletFlyingTick.executeProcedure($_dependencies);
			}
			if (this.inGround) {
