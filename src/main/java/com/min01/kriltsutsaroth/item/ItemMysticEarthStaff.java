...
import com.min01.kriltsutsaroth.procedure.ProcedureMysticEarthStaffWhileBulletFlyingTick;
import com.min01.kriltsutsaroth.procedure.ProcedureMysticEarthStaffBulletHitsLivingEntity;
...
public class ItemMysticEarthStaff extends ElementsKriltsutsarothMod.ModElement {
	...
	public void preInit(FMLPreInitializationEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(EntityArrowCustom.class, renderManager -> {
			return new RenderSnowball(renderManager, new ItemStack(Blocks.DIRT, (int) (1), 0).getItem(), Minecraft.getMinecraft().getRenderItem());
		});
	}
	...
	public static class EntityArrowCustom extends EntityTippedArrow {
		...
		protected void arrowHit(EntityLivingBase entity) {
			...
			World world = this.world;
			{
				...
				ProcedureMysticEarthStaffBulletHitsLivingEntity.executeProcedure($_dependencies);
			}
		}
		...
		public void onUpdate() {
			...
			Entity entity = (Entity) shootingEntity;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ProcedureMysticEarthStaffWhileBulletFlyingTick.executeProcedure($_dependencies);
			}
			if (this.inGround) {
