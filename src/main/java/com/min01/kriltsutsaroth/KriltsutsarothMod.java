 ...
 *
 *    Keep the ElementsKriltsutsarothMod object in this class and all calls to this object
...
public class KriltsutsarothMod {
	...
	@Mod.Instance(MODID)
	public static KriltsutsarothMod instance;
	public ElementsKriltsutsarothMod elements = new ElementsKriltsutsarothMod();
	@Mod.EventHandler
	public void preInit(FMLPreInitializationEvent event) {
		MinecraftForge.EVENT_BUS.register(this);
		GameRegistry.registerWorldGenerator(elements, 5);
		GameRegistry.registerFuelHandler(elements);
		NetworkRegistry.INSTANCE.registerGuiHandler(this, new ElementsKriltsutsarothMod.GuiHandler());
